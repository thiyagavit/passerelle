...
/**
 * This class encapsulates a system command to python used with the RPC service and drives python using the diamond RPC link. It is a subset of the RPC
 * interface available by diamond pertinent to running python commands in the way jep does.
 */
