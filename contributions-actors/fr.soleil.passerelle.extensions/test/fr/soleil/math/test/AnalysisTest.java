...
import be.isencia.passerelle.actor.ProcessingException;
import fr.esrf.Tango.DevFailed;
import fr.soleil.math.Analysis;
import fr.soleil.math.BeamCalculations;
import fr.soleil.math.test.BeamProfiles;
...
public class AnalysisTest {
	...
	public void fwhm() {
		 ...
		 * e.printStackTrace(); }
		 */
		final double result = BeamCalculations.fwhm(functions.createLine(100),
				l);
		System.out.println("fwhm posistion is " + result);
		Assert.assertEquals(expectedFWHM, result, 0.1);
	...
	public void centroid() {
		...
		Assert.assertEquals(expectedCentroid, result, 0.1);
