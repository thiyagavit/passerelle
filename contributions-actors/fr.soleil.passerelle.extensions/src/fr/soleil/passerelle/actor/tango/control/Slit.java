...
public class Slit extends MotorMover {

	static Vector<String> attributeList = new Vector<String>();
	static {
		attributeList.add("gap");
		attributeList.add("position");
		attributeList.add("insideUpPosition");
		attributeList.add("outsideDownPosition");
	}

	public Slit(final CompositeEntity container, final String name)
			throws NameDuplicationException, IllegalActionException {
		super(container, name, attributeList);
		final URL url = this.getClass().getResource("/image/slit.png");
		_attachText(
				"_iconDescription",
				"<svg>\n"
