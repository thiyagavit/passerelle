...
public class ModelExecutor extends Actor {
  ...
  public ModelExecutor(CompositeEntity container, String name) throws IllegalActionException, NameDuplicationException {
  ...
  protected void doFire() throws ProcessingException {
    ...
    try {
      ...
      throw new ProcessingException("Error sending output data", outputTrigger, e2);
    }
