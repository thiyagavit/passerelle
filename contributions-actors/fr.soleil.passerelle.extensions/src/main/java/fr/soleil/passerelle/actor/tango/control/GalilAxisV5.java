...
import fr.soleil.passerelle.actor.tango.control.motor.dataProviders.NoAttributeDataProvider;
import fr.soleil.passerelle.actor.tango.control.motor.dataProviders.PortAttributeDataProvider;
...
public class GalilAxisV5 extends AGalilMotorActor implements IActorFinalizer {
    ...
    public AttributeDataProvider createPositionDataProvider() {
        return new PortAttributeDataProvider();
    }

    @Override
    public AttributeDataProvider createOffsetDataProvider() {
        return new NoAttributeDataProvider();
    }
