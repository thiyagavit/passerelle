...
//		}
     ...
     * @return
     */
//    public Token convertEventToSimpleTypedToken(final Event event, final Type targetType)
//	    throws UnsupportedOperationException, PasserelleException {
//	logger.debug("convertAttributeToSimpleTypedToken");
//	final PtolemyType type = PtolemyType.getPtolemyType(targetType);
//	Token result;
...
//    }
     ...
     */
//    @SuppressWarnings("unchecked")
//    public Object convertEventToSimpleTypedObject(final Event event, final Class targetType)
//	    throws UnsupportedOperationException, PasserelleException {
//	Object result;
...
//    }
	...
	try {
//	    if (Event.class.isAssignableFrom(targetType)) {
//		result = new ResultItemImpl(content.getName(), content.extract(String.class), null, new Date(
