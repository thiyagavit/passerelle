...
import fr.soleil.passerelle.actor.tango.control.motor.dataProviders.HdbAttributeDataProvider;
...
public class DefineOffsetPositionWithLastHdbValue extends AGalilMotorActor {

    private WaitStateTask waitTask;

    public DefineOffsetPositionWithLastHdbValue(CompositeEntity container, String name)
    ...
    public AttributeDataProvider createOffsetDataProvider() {
        return new HdbAttributeDataProvider("offset", false);
    }
    ...
    public AttributeDataProvider createPositionDataProvider() {
        return new HdbAttributeDataProvider("position", true);
    }
}
