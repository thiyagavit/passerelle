 ...
 * <p>
 * It can be configured with a numerical range and a step size. This loop actor buffers the loop steps and only triggers
 * a next step after getting a confirmation that the previous one has been completely processed by the model's loop.
 * </p>
 * <p>
 * This is done by sending an output "step" msg containing the numerical value for a given step. <br/>
 * The actor sends a first message immediately after receiving a loop "trigger"message. It expects to receive a
 * "handled" msg when the loop has done its iteration for a given step value. Only after receiving such a "handled" msg,
 * the next step's value msg is sent out.
 * </p>
 * <p>
...
public class ForLoopWithPortCfg extends AbstractSequenceStepper {
     ...
     */
    public ForLoopWithPortCfg(final CompositeEntity container, final String name) throws IllegalActionException,
        ...
        _attachText("_iconDescription", "<svg>\n" + "<rect x=\"-25\" y=\"-25\" width=\"50\" "
                ...
                + "<line x1=\"-24\" y1=\"25\" x2=\"25\" y2=\"25\" " + "style=\"stroke-width:1.0;stroke:black\"/>\n"
    ...
    protected void setLoopConfiguration() throws ProcessingException {
        try {
            ...
            throw new ProcessingException(ErrorCode.ACTOR_EXECUTION_ERROR, "Error reading loop start/end values", this,
                    e);
        }
    ...
    /**
     * React on each received trigger message, by generating a complete loop step sequence again, and store the steps in
     * a queue.
     */
    @Override
