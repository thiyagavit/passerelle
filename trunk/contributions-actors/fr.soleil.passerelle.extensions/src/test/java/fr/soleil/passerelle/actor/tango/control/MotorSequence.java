...
public class MotorSequence extends TangoUnitTest {
	...
	public void testBasic() throws Exception {
		topLevel = FlowHelperForTests.loadMoml(MotorSequence.class,
				"/fr/soleil/passerelle/resources/motor.moml");
	...
	public void testRealStop() throws Exception {
		...
		props.put("MotorMover.Device Name", deviceName);
		final FlowManager manager = FlowHelperForTests.executeNonBlocking(
				topLevel, props);
		// Thread.sleep(10);
