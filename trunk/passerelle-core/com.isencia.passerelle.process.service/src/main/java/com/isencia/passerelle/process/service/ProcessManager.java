...
public interface ProcessManager {
	 ...
	 * 
	 * @param task Task for which status change notifications are posted
	...
	/**
	 * Unsubscribe the given callback.
	 * It can be an "all" subscriber or one subscribed for a specific task.
	 * 
	 * @param callback
	 */
