 ...
 * @author erwin
 */
public abstract class TaskBasedMessageSequenceGenerator extends TaskBasedActor implements MessageSequenceGenerator {
  private static final long serialVersionUID = 1L;
  private static final Logger LOGGER = LoggerFactory.getLogger(TaskBasedMessageSequenceGenerator.class);
   ...
   */
  public TaskBasedMessageSequenceGenerator(CompositeEntity container, String name, boolean stateful) throws IllegalActionException, NameDuplicationException {
