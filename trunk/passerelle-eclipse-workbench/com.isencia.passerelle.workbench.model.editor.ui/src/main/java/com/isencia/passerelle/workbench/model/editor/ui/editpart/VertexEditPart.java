...
public class VertexEditPart extends AbstractNodeEditPart implements IActorNodeEditPart {
  ...
  protected List getModelSourceConnections() {
    ...
    TypedIORelation relation = (TypedIORelation) ((Vertex) getModel()).getContainer();
    ...
    for (Object o : relation.linkedObjectsList()) {
      if (o instanceof TypedIORelation) {
        Object rel = getRelation(relation, ModelUtils.getVertex((Relation) o), (Vertex) getModel(), true);
        if (rel != null)
          relations.add(rel);
  ...
  protected List getModelTargetConnections() {
    ...
    for (Object o : relation.linkedObjectsList()) {
      if (o instanceof TypedIORelation) {
        Object rel = getRelation(relation, (Vertex) getModel(), ModelUtils.getVertex((Relation) o), false);
        if (rel != null)
          relations.add(rel);
      }
    }
  ...
  public static Object getRelation(TypedIORelation relation, Object o, Vertex vertex, boolean isSource) {
    ...
    if (map.containsKey(o)) {
      ...
      if (o instanceof IOPort) {
        ...
        if ((isSource && isSource((Vertex) o)) || (!isSource && isTarget(vertex)))
          relationObject = new VertexLink((Vertex) o, vertex, isSource);
      }
  ...
  private double[] getLocation(ConnectionEditPart connEditPart, boolean isSource) {
    ...
    if (model instanceof VertexLink) {
      ...
      if (relation.getPort() != null) {
        location = ModelUtils.getLocation(((VertexLink) model).getPort().getContainer());
      } else if (!isSource && relation.getTargetVertex() != null) {
        location = ModelUtils.getLocation(((VertexLink) model).getTargetVertex());
      } else if (isSource && relation.getSourceVertex() != null) {
        location = ModelUtils.getLocation(((VertexLink) model).getSourceVertex());
      }
    }
    return location;
  }
