...
//            paramCount = buildTopLevelCfgPane(model, paramCount, COLLAPSED);
	...
	private int addParameterFiltersForComposite(JPanel parentPanel, Collection<JXTaskPane> taskPanes, CompositeActor model, CompositeActor parent, int paramCount, boolean collapsed) {
