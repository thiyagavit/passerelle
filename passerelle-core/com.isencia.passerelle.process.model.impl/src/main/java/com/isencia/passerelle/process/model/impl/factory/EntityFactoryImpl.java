...
public class EntityFactoryImpl implements EntityFactory {
   ...
   */
  public Request createRequest(Case requestCase, String initiator, String type, String correlationId) {
    return new RequestImpl(requestCase, initiator, type, correlationId);
  }
