  ...
  private void sendStepMessage() throws ProcessingException {
    ...
    if (step != null) {
      if (step.isEndMarker()) {
        ...
        ExecutionTracerService.trace(this, "Step sequence has been interrupted at step number " + step.stepCtr);
        ...
        try {
          ...
          ExecutionTracerService.trace(this, "Step with value " + step.stepValue);
