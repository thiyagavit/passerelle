 ...
 *
 * Using a lightly hacked edition of the equinox prefs bundle, this can work also outside a running OSGi/Equinox platform,
 * e.g. in plain Java/JUnit test runs.
 * 
 * @author durdav
 * @author delerw
 *
...
//	}
	...
	/**
	 * Dumps the preferences starting from the given node,
	 * on the given writer.
	 * 
	 * @param writer
	 * @param node
