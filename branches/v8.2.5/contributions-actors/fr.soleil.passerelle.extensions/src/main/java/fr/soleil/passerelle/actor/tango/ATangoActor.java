...
public abstract class ATangoActor extends Actor {

	private static final Logger logger = LoggerFactory.getLogger(ATangoActor.class);
	...
	public ATangoActor(final CompositeEntity container, final String name)
		...
		recordDataParam = new Parameter(this, RECORD_DATA, new BooleanToken(
				false));
	...
	public void attributeChanged(final Attribute arg0)
		...
		if (arg0 == recordDataParam) {
			recordData = PasserelleUtil
					.getParameterBooleanValue(recordDataParam);
		} else {
