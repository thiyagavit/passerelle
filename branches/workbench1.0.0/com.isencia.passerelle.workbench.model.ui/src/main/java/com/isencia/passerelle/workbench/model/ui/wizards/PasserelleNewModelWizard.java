...
public class PasserelleNewModelWizard extends Wizard implements INewWizard {
	private PasserelleNewModelWizardPage page;
	private ISelection selection;

	/**
	 * Constructor for PasserelleNewModelWizard.
	 */
	public PasserelleNewModelWizard() {
		super();
	...
	public void addPages() {
		page = new PasserelleNewModelWizardPage(selection);
		addPage(page);
	}
