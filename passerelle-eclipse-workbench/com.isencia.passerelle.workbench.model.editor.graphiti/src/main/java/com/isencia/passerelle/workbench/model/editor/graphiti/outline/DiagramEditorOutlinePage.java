...
*/
package com.isencia.passerelle.workbench.model.editor.graphiti.outline;
 ...
 * 
 * @see org.eclipse.graphiti.DiagramEditorOutlinePage.common.outline.GraphicsEditorOutlinePage
 */
...
public class DiagramEditorOutlinePage extends ContentOutlinePage implements IPropertyListener {
   ...
   * @since 0.9
   */
  public DiagramEditorOutlinePage(DiagramEditor diagramEditor) {
  ...
  public void initContents() {
    ...
    getViewer().setContents(DiagramFlowRepository.getFlowForDiagram(diagram));
  }
