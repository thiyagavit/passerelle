...
public class OpenClosePositioner extends ATangoDeviceActor {
	...
	public OpenClosePositioner(final CompositeEntity arg0, final String arg1)
	...
	protected void process(final ActorContext ctxt,
		...
		try {
			...
			if (isMockMode()) {
				if (action.equalsIgnoreCase("Close")) {
					ExecutionTracerService.trace(this, "MOCK - closing "
							+ deviceName);
					ExecutionTracerService.trace(this, "MOCK - " + deviceName
							+ " is closed");
				} else {
					ExecutionTracerService.trace(this, "MOCK - opening "
							+ deviceName);
					ExecutionTracerService.trace(this, "MOCK - " + deviceName
							+ " is opened");
				}
