...
public class DeleteFileAction extends AbstractAction {
	 ...
	 */
	private final Map<URI, Flow> map;

	public DeleteFileAction(final String desc, final JFileChooser aChooser, final Map<URI, Flow> aMap) {
		super(desc);
		chooser = aChooser;
		map = aMap;
