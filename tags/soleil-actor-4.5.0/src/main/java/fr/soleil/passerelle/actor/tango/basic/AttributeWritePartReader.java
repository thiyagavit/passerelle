...
public class AttributeWritePartReader extends ATangoAttributeActor {
     ...
     */
    public AttributeWritePartReader(final CompositeEntity container,
	...
	if (isMockMode()) {
	    ...
	    response.addOutputMessage(0, output, PasserelleUtil
		    .createContentMessage(this, 10.0));
		...
		if (isRecordData()) {
		    DataRecorder.getInstance().saveDevice(this,
			    getTangoAttribute().getDeviceName());
		}
	    ...
	    // value));
	    response.addOutputMessage(0, output, PasserelleUtil
		    .createContentMessage(this, value));
