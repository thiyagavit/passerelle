...
public class Expression extends DynamicPortsActor {
	 ...
	 */
	public Expression(final CompositeEntity container, final String name) throws IllegalActionException, NameDuplicationException {
	...
	@Override
	protected void process(final ActorContext arg0, final ProcessRequest request, final ProcessResponse response) throws ProcessingException {
		if (logger.isTraceEnabled()) {
		...
		try {
			...
			throw new ProcessingExceptionWithLog(this, "Expression invalid : " + ex.getMessage(), this, ex);
		...
		if (result == null) {
			...
			throw new ProcessingExceptionWithLog(this, "Expression yields a null result: " + expression.getExpression(), this, null);
		}
		if (assignement) {
