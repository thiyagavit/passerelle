...
public class AttrScalarPanel extends javax.swing.JPanel {
	...
	*/
	...
	private void initGUI() {
		try {
			this.setPreferredSize(new java.awt.Dimension(351, 43));		
			...
			this.setLayout(thisLayout);
			{
				...
				//simpleScalarViewer.setPreferredSize(new java.awt.Dimension(130, 48));
				//simpleScalarViewer.setPreferredSize(new java.awt.Dimension(133, 54));
			}
		} catch (Exception e) {
			e.printStackTrace();
		}
