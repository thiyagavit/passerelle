...
public class ScientaAcquisition extends ATangoDeviceActor implements IActorFinalizer {
     ...
     */
    public ScientaAcquisition(final CompositeEntity arg0, final String arg1)
	...
	if (isMockMode()) {
	    ...
	    response.addOutputMessage(2, dataPort, PasserelleUtil
		    .createContentMessage(this, value2));
