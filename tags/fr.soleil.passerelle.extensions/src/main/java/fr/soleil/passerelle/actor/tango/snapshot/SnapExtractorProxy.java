...
public class SnapExtractorProxy {
    ...
    SnapExtractorProxy(final String snapExtractorName) throws DevFailed {
     ...
     * @throws DevFailed
     */
    public String[] getReadValues(final String snapID, final String... attributeNames) throws DevFailed {
     ...
     * @throws DevFailed
     */
    public String[] getWriteValues(final String snapID, final String... attributeNames) throws DevFailed {
