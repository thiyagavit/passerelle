...
public class CCDSequence extends TangoUnitTest {
	...
	public static List<Object[]> getParametres() {
		...
		return Arrays.asList(new Object[][] { { "DirTango", false },
				{ "DirMock", true } });
	}
	...
	public static void setUp() {
		...
		try {
			...
			tangounit.addDeviceProperties(d.getName(), "AttributesList",
					...
					"roi1ymax;DEVSHORT;SCALAR", "xbin;DEVSHORT;SCALAR",
					"ybin;DEVSHORT;SCALAR", "frames;DEVSHORT;SCALAR",
					"trigger;DEVSHORT;SCALAR", "acqMode;DEVSHORT;SCALAR",
					"exposure;DEVDOUBLE;SCALAR", "timing;DEVDOUBLE;SCALAR");

			tangounit.addDeviceProperties(d.getName(), "CommandsList",
					"Start;DevVoid;DevVoid", "Stop;DevVoid;DevVoid",
					"SetAverageIntensity0;DevVoid;DevVoid");
	...
	public void testNormal() {
		topLevel = FlowHelperForTests.loadMoml(this.getClass(),
				"/fr/soleil/passerelle/resources/ccd.moml");
	...
	public void testStop() {
		...
		parameters.put("AcquisitionAviexSwing.Device Name", deviceName);
		parameters.put("AcquisitionPrincetonOde.Device Name", deviceName);
		final FlowManager flowMgr = FlowHelperForTests.executeNonBlocking(
				topLevel, parameters);
		try {
			Thread.sleep(10);
