...
public class AttributeImageCalculation extends TransformerV3 {
	...
	private final static Logger logger = LoggerFactory
			.getLogger(AttributeImageCalculation.class);
	...
	public AttributeImageCalculation(final CompositeEntity container,
		...
		storedAttributeNameParam = new StringParameter(this,
				STORED_ATTRIBUTE_PARAM_NAME);
			...
			try {
				...
				if (!storedTangoAttribute.isImage()) {
					throw new InitializationException(
							"Invalid Stored Attribute Format", this, null);
				}

				if (!storedTangoAttribute.isNumber()
						&& !storedTangoAttribute.isBoolean()) {
					throw new InitializationException(
							"Invalid Stored Attribute Type", this, null);
				}

				if (!storedTangoAttribute.isWritable()) {
					throw new InitializationException(
							"Invalid Stored Attribute is not Writable", this,
							null);
				}
				...
				throw new InitializationException(e.getMessage(), this, e);
			}
		}
		if (logger.isTraceEnabled()) {
	...
	protected void process(final ActorContext ctxt,
		...
		response.addOutputMessage(0, output, PasserelleUtil
				.createContentMessage(this, accumul));
	}
}
