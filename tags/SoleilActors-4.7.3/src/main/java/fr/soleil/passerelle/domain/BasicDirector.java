...
public class BasicDirector extends com.isencia.passerelle.domain.cap.Director {
  ...
  private void init() throws IllegalActionException, NameDuplicationException {
    ...
    _attachText("_iconDescription", "<svg>\n" + "<rect x=\"0\" y=\"0\" width=\"160\" " + "height=\"80\" style=\"fill:white;stroke:black\"/>\n"
   ...
   * @throws NameDuplicationException
   */
  public BasicDirector(final CompositeEntity container, final String name) throws IllegalActionException, NameDuplicationException {
  ...
  public void initialize() throws IllegalActionException {
    ...
    if (getAdapter(null).isMockMode()) {
      ...
      ExecutionTracerService.trace(this, "###START " + modelName + "### with strategy " + errorStrategy.toString());
