...
public class AttributeBaseConverter implements com.isencia.passerelle.message.type.TypeConverter {
  ...
  public Token convertPasserelleTokenToPtolemyToken(final PasserelleToken passerelleMsgToken, final Type targetType) throws UnsupportedOperationException,
      PasserelleException {
...
//          } else 
          ...
          throw new PasserelleException("Unexpected error during conversion attempt", passerelleMsgToken, e);
        }
  ...
  public PasserelleToken convertPtolemyTokenToPasserelleToken(final Token origToken, final Class targetType) throws UnsupportedOperationException,
      PasserelleException {
...
//        } else 
   ...
   * @return
   */
  public Token convertAttributeToSimpleTypedToken(final TangoAttribute content, final Type targetType) throws UnsupportedOperationException,
      PasserelleException {
    ...
    try {
      ...
      if (content.isScalar()) {
        try {
          ...
          throw new PasserelleException("Error during construction of Token", content, e);
        }
      } else {
        ...
        try {
          ...
          throw new PasserelleException("Error during construction of ArrayToken", content, e);
        }
      }
      return result;
    } catch (final DevFailed e) {
      throw new PasserelleException(TangoToPasserelleUtil.getDevFailedString(e, (Director) null), content, e);
    }
  }
...
//  }
   ...
   */
  @SuppressWarnings("unchecked")
  public Object convertAttributeToSimpleTypedObject(final TangoAttribute content, final Class targetType) throws UnsupportedOperationException,
      PasserelleException {
    Object result;
...
//      } else 
   ...
   */
  @SuppressWarnings("unchecked")
  public PasserelleToken convertPasserelleMessageContent(final PasserelleToken origToken, final Class targetContentType) throws UnsupportedOperationException,
      PasserelleException {
