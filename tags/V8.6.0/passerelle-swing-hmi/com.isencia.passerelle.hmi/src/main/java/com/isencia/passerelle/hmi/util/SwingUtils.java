...
public final class SwingUtils {
	 ...
	 */
	public static <T extends JComponent> List<T> getDescendantsOfType(final Class<T> clazz, final Container container) {
	 ...
	 * @return the List of components
	 */
	public static <T extends JComponent> List<T> getDescendantsOfType(final Class<T> clazz, final Container container, final boolean nested) {
	 ...
	 *             be accessed
	 */
	public static <T extends JComponent> T getDescendantOfType(final Class<T> clazz, final Container container, final String property, final Object value) throws IllegalArgumentException {
	 ...
	 *             be accessed
	 */
	public static <T extends JComponent> T getDescendantOfType(final Class<T> clazz, final Container container, final String property, final Object value, final boolean nested)
	 ...
	 * @return the List of components
	 */
	public static <T extends JComponent> List<T> getDescendantsOfClass(final Class<T> clazz, final Container container) {
	 ...
	 * @return the List of components
	 */
	public static <T extends JComponent> List<T> getDescendantsOfClass(final Class<T> clazz, final Container container, final boolean nested) {
		final List<T> tList = new ArrayList<T>();
		for (final Component component : container.getComponents()) {
	 ...
	 *             be accessed
	 */
	public static <T extends JComponent> T getDescendantOfClass(final Class<T> clazz, final Container container, final String property, final Object value) throws IllegalArgumentException {
	 ...
	 *             be accessed
	 */
	public static <T extends JComponent> T getDescendantOfClass(final Class<T> clazz, final Container container, final String property, final Object value, final boolean nested)
			throws IllegalArgumentException {
		final List<T> list = getDescendantsOfClass(clazz, container, nested);
		return getComponentFromList(clazz, list, property, value);
	}

	private static <T extends JComponent> T getComponentFromList(final Class<T> clazz, final List<T> list, final String property, final Object value) throws IllegalArgumentException {
		final T retVal = null;
		Method method = null;
		try {
	...
	public static Map<JComponent, List<JComponent>> getComponentMap(final JComponent container, final boolean nested) {
		final HashMap<JComponent, List<JComponent>> retVal = new HashMap<JComponent, List<JComponent>>();
