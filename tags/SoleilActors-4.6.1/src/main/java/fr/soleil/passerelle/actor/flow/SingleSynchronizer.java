...
public class SingleSynchronizer extends DynamicPortsActor {
	 ...
	 */
	public SingleSynchronizer(final CompositeEntity container, final String name)
	...
	protected void process(final ActorContext ctxt,
		...
		final Iterator<MessageInputContext> allInputContexts = request
				.getAllInputContexts();
		int inputProcessed = 0;
		while (allInputContexts.hasNext()) {
			final MessageInputContext messageInputContext = allInputContexts
					.next();
