...
public class GratingMonochromator extends MotorMover {
    static Vector<String> attributeList = new Vector<String>();
    static {
        attributeList.add("energy");
        attributeList.add("lambda");
        attributeList.add("beta");
        attributeList.add("gratingPosition");
        attributeList.add("exitSlitAperture");
    }

    public GratingMonochromator(final CompositeEntity container, final String name)
            throws NameDuplicationException, IllegalActionException {
        super(container, name, attributeList);
        final URL url = this.getClass().getResource("/image/BL_MonoGrating.png");
