...
public class Attenuator extends MotorMover {
	static Vector<String> attributeList = new Vector<String>();
	static {
		attributeList.add("computedAttenuation");
		attributeList.add("filtersCombination");
	}

	public Attenuator(final CompositeEntity container, final String name)
			throws NameDuplicationException, IllegalActionException {
		super(container, name, attributeList);
		final URL url = this.getClass().getResource("/image/BL_Filter.png");
		_attachText(
				"_iconDescription",
				"<svg>\n"
